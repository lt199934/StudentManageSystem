...
.right_triangle{ height:0px; width:0px; border-width:8px; border-style:solid; border-color:transparent transparent transparent gold; position: relative; right:-16px; top:3px;overflow-x: hidden; }
		...
		<body>
			<div class="div1">
				...
				<div class="div03">
					<form action="StudentServlet?num=6&sxr=赵铁柱" method="post">
						<!-- <textarea name="message" id="mess" cols="120" rows="14"></textarea> -->
						<textarea name="message" cols="62" rows="10" id="mess"></textarea>
						<input type="submit" id="submit" style="width:90px;height: 40px;background-color: #426374;color:white"  value="发送">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" style="width:90px;height: 40px;background-color: #426374;color:white" value="重置">
					</form>
				</div>
			</div>
		</body>
