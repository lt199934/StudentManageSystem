...
<body>
	<div class="login">
		<div class="top"><h1><a href="/studentManageSystem/admin/index.jsp"><img src="../img/logo.png"></a></h1><h2>学生管理系统</h2><br><br> <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">管理员：${sessionScope.user.userName }&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="../LoginServlet?temp=logout" id="loginOut">安全退出</a></span>
</div>
		<div class="center">
		<!--导航菜单 -->
			<div class="menu">
